    ...
    <div class="content">
        ...
        <div class="content-bar">
            <div style='position:relative; margin-top: 15px; '>
                <h2 style='margin-right:20px; font-size: 32px; font-weight: 550;'>المواد الدراسية</h2>
            </div>
            <?php

            if ($_SESSION["admin_user"] != "college") {
            ?>
                <button class="btn-style" onclick="window.open('add_courses' , '_self');">
            ...
            <div class="group">
                ...
                <input id="search" name="search" placeholder="ادخل اسم المادة او القسم" type="search" onkeyup="search()" class="input-placeholder">
            </div>
    ...
    <script>
        $(document).ready(function() {
            $("#search").on("input", function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../university-education-compass/assets/pg/admins/search/search_courses.php",
                    data: {
                        search: searchValue
                    },
