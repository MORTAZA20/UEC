    ...
    <div class="content">
        ...
        <div class="content-bar">
            <div style='position:relative; margin-top: 15px; '>
                <h2 style='margin-right:20px; font-size: 32px; font-weight: 550;'>الاقسام
            </div>
            <?php

            if ($_SESSION["admin_user"] != "college") {
            ?>
                <button class="btn-style" onclick="window.open('add_departments' , '_self');">
    ...
    <script>
        $(document).ready(function() {
            $("#search").on("input", function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "../university-education-compass/assets/pg/admins/search/search_inf_departments.php",
                    data: {
                        search: searchValue
                    },
