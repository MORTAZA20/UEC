...
if (isset($_POST['search'])) {
    ...
    if ($_SESSION["admin_user"] == "college") {
        ...
        $sql = "SELECT departments.*, colleges.college_name FROM departments
                LEFT JOIN colleges ON departments.college_id = colleges.college_id WHERE (department_name LIKE '%$search%' OR colleges.college_name LIKE '$search') AND colleges.college_id ='$college_id'";
    } else {
        $sql = "SELECT departments.*, colleges.college_name FROM departments
    ...
    if ($_SESSION["admin_user"] == "college") {
        $college_id = $_SESSION["college_id"];
        $sql = "SELECT departments.*, colleges.college_name FROM departments
                LEFT JOIN colleges ON departments.college_id = colleges.college_id WHERE colleges.college_id ='$college_id'";
    } else {
        $sql = "SELECT departments.*, colleges.college_name FROM departments
