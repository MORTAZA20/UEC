            ...
            if (isset($_POST["sub_form"])) {
                ...
                if ($resultTest->num_rows > 0) {
                    ...
                    if ($_FILES['colleges_images']['type'] === 'image/png' || $_FILES['colleges_images']['type'] === 'image/jpeg') {
                        ...
                        $image_path = $colleges_folder . '/' . $file_name;
            ...
            <div class="container-form">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="custom-column" style="margin-bottom: 10px;">
                        ...
                        <input type="text" style="margin: 0px 10px;" name="college_name" id="row-2" placeholder="اسم الكلية" required>
                    ...
                    <input type="file" name="colleges_images" class="file-btn" id="files" accept="image/png, image/jpeg" >
                            <input type="button" class="file-btn" value="اختيار شعار الكلية" onclick="document.getElementById('files').click();">
                    <p>
