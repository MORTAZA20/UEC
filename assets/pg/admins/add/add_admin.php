    ...
    <div class="content">
        ...
        <div class="content-bar">
            <div style='position:relative; margin-top: 15px;'>
                <h2 style='margin-right:20px; font-size: 32px; font-weight: 550;'>إضافة مشرف جديد</h2>
            </div>
            <div class="path-bar">
            ...
            if (isset($_POST["sub_form"])) {
                ...
                $sql_CHECK_inf_login = "SELECT * FROM inf_login WHERE Admin_id ='$Admin_id' or AdminUserName = '$AdminUserName'";
                $result_sql_CHECK_inf_login = $conn->query($sql_CHECK_inf_login);
                if ($result_sql_CHECK_inf_login->num_rows > 0) {
                    echo "<div id='success-message' style='margin:20px; padding:10px 15px; font-size: 18px; background-color:#ffe6e6; border-radius: 5px;'>معرف المستخدم او اسم المستخدم موجود مسبقا.</div>";
                } else {
            ...
            <div class="container-form">
                <form action="" method="post">
                    ...
                    <input type="text" name="Admin_id" placeholder="معرف المستخدم" style=" margin-bottom: 10px ;" required>
