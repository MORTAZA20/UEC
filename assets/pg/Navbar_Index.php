...
<div class="side" id="ShowSide">
    <ul class="side-menu">
        <li class="side-menu-item" onclick="window.open('../university-education-compass/', '_self');"><i class="fa-solid fa-house"></i> الرئيسية</li>
        <li class="side-menu-item active" id="side-menu1">الجامعات
            <i class="fa-solid fa-caret-down"></i>
        </li>
        <ul class="menu-dep-universities" id="ShowSideMenu1">
            <?php
            $sql = "SELECT * FROM universities";
            $result = $conn->query($sql);
            while ($row = $result->fetch_assoc()) {
        ...
        <li class="side-menu-item active" id="side-menu2">الكليات
            <i class="fa-solid fa-caret-down"></i>
        </li>
        <ul class="menu-dep-colleges" id="ShowSideMenu2">
            <?php
            $sql2 = "SELECT  c.*, u.university_name
                FROM colleges c
                LEFT JOIN universities u ON c.university_id = u.university_id ";
        ...
        <li class="side-menu-item active" id="side-menu3">الاقسام العلمية
            <i class="fa-solid fa-caret-down"></i>
        </li>
        <ul class="menu-dep-departments" id="ShowSideMenu3">
            <?php
            $sql3 = "SELECT d.*, c.college_name, u.university_name
                FROM departments d
                LEFT JOIN colleges c ON d.college_id = c.college_id
